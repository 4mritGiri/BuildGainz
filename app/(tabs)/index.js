import { StyleSheet, useColorScheme, ScrollView, FlatList, Pressable, } from 'react-native';
...
const My_Program = [
  {
    id: '12',
    image: "https://images.unsplash.com/photo-1577221084712-45b0445d2b00?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8Z3ltJTIwd29ya291dHxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60",
    workoutName: 'Workout Name',
    details: "14 Workouts-12 Mins-Beginner ",
  },
  {
    id: '13',
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR98WWJE6HX2CQocYx26D-iDAA10c43vBoAfA&usqp=CAU",
    workoutName: 'Workout Name',
    details: "14 Workouts-12 Mins-Beginner ",
  },
  {
...
export default function ReportsScreen() {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colorScheme ? ligntColors.background : darkColor.blackground }]}>
      <Header />
      <ScrollView
      ...
      >
        ...
        <WaterDrank />
        <Pressable 
          onPress={()=> router.push("/(report)/FeedingReport")}
        >
          <Feeding />
        </Pressable>
      </ScrollView>
