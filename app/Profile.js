  ...
  return (
    ...
    >
      ...
      <ScrollView>
        ...
        <Text lightColor={ligntColors.lightGray} style={[styles.infoText]}>
          Profile Information
        </Text>
        <TextInputField
          label={"Name"}
          value={"Amrit Giri"}
          placeholder={"eg: Amrit Giri"}
        />
        <TextInputField
          label={"Email Address"}
          value={"amritgiri@gmail.com"}
        ...
        <View>
          <TextInputField
            ...
            style={{ width: wp("46%"), borderRadius: 10, textAlign: "center" }}
          />
        </View>

        <View style={{ marginLeft: 10 }}>
          <Label
            style={{ marginBottom: 0, marginBottom: 20 }}
            label={"BMI(kg/m)"}
          />
